...
import AsyncProxiedImage from "@/components/AsyncProxiedImage";
        ...
        <div className="max-w-4xl mx-auto px-4 py-8">
            ...
            <article className="markdown-body markdown-body-dark max-w-none mb-5">
                <ReactMarkdown
                    ...
                    components={{
                        img: (props) => (
                            <Suspense fallback={<img src={props.src} alt={props.alt} {...props} />}>
                                <AsyncProxiedImage src={props.src} alt={props.alt} {...props} />
                            </Suspense>
                        ),
